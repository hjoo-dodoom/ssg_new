			...
			u = {
				...
				_modalConent: function() {
					...
					if (t.buttons || t.buttons != null) {
						...
						switch (t.type) {
							case "cart":
								c = '<a class="modal-btn' + (t.buttons[0].addClass ? " " + t.buttons[0].addClass : "") + '">' + a.shopping + '</a><a href=' + '"../cart/cart.html"' +' class="modal-btn ' + (t.buttons[1] && t.buttons[1].addClass ? " " + t.buttons[1].addClass : "btn-light-blue") + '">' + a.cart + "</a>";
								break;
							case "alert":
					...
					if (t.autoclose) {
						var h = t.buttons || t.buttons != null ? e(r).text().length * 32 : 3000;
						u._modalHide(h < 3000 ? 3000 : h)
					}
					i.fadeIn(200);
					u._position();
				},
